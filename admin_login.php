  ...
  <br>
    ...
    <main id="main-holder">
        ...
        <div class="login_img">
          ...
          <img src="pngegg.png" width = "120" height = "120" /> 
      
         </div> 
        <form id="login-form" method="post" action="#">
          <input type="text"  id="username-field" name="username-field" class="login-form-field" placeholder="Username">
          <input type="password"  id="password-field" name="password-field" class="login-form-field" placeholder="Password">
